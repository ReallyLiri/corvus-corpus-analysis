...
import BgAnimation from "./assets/img/idea-bg-animation.gif"
...
const Images = [
    BatAnimation, BgAnimation, Start, CleanBackground, TitleBrief, TitleMoodboard, TitleMarket, PageBrief
];
...
const App = () => {
    ...
    return <React.Fragment>
        ...
        {
            !contentLoaded && <StyledImage src={CleanBackground} alt="background" className={backgroundLoaded ? "visible" : "hidden"}/>
        }
        {
        ...
        {
            contentLoaded &&
            pageIndex >= 0 && <StyledImage src={PageBrief} alt="background"/>
        }
    </React.Fragment>;
};
